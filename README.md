...
1. BEScript语法高亮(符合LSP标准)
2. BEScript快速重构入口(包括手动快速重构和MCP工具)
3. 自动同步的视图映射:TS和HTML格式视图
4. 基于视图语法规则的patch支持(仅支持MCP),以及类似git patch格式的修改草稿二次提交
5. Lint诊断
